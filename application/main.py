...
def Roman_to_urdu(sentence):
    ...
    for i in range(len(words)):
        ...
        if word in map_dict.keys():
            ...
            urdu_list.append(map_dict[word][0])
        else:
            # FIX: Skip the slow network call. Use the original Roman Urdu word as fallback.
            # This is instantaneous and necessary for non-mapped words (like proper nouns).
            urdu_list.append(word)
